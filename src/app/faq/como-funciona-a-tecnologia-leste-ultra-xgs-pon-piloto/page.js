...
export const metadata = {
  ...
  description:
    "Informações sobre fase piloto, cobertura, instalação, equipamentos e condições de uso do Leste Ultra (XGS-PON).",
};
        ...
        <article className="mt-10 max-w-4xl rounded-xl border border-graylighter bg-white px-6 py-8 md:px-8">
          <div className="space-y-5 text-base leading-7 text-dark md:text-lg md:leading-8">
            ...
            <p>
              ...
              havendo garantia de instalação até a aprovacao final. Mesmo após
              o pedido, podem existir limitacoes técnicas que impecam a ativação
              do serviço.
            </p>
            ...
            <p>A garantia de banda segue os limites legais e contratuais.</p>
