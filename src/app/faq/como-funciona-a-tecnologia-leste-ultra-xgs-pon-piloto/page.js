...
export const metadata = {
  ...
  description:
    "Informacoes sobre fase piloto, cobertura, instalacao, equipamentos e condicoes de uso do Leste Ultra (XGS-PON).",
};
        ...
        <article className="mt-10 max-w-4xl rounded-xl border border-graylighter bg-white px-6 py-8 md:px-8">
          <div className="space-y-5 text-base leading-7 text-dark md:text-lg md:leading-8">
            ...
            <p>
              ...
              havendo garantia de instalacao ate a aprovacao final. Mesmo apos
              o pedido, podem existir limitacoes tecnicas que impecam a ativacao
              do servico.
            </p>
