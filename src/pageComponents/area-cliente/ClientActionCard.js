...
export default function ClientActionCard({item}) {
  const className = "group flex items-center md:items-start justify-between gap-y-2 rounded-xl bg-lightgreenBackground p-8 text-primary md:min-h-[224px] md:flex-col";
  const content = (
    <>
