...
export default function BannerMovel() {
    return (
        <section className="mt-[88px] md:mt-[123px] w-full bg-[url('/bannermovel-mobile.png')] md:bg-[url('/banner-movel-05-2026.png')] bg-contain bg-no-repeat bg-darkgreen md:bg-center">
