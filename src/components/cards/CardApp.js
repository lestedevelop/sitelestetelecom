...
export default function CardApp({suporte,central,download,link}) {

    return (
      <>
          {suporte&& <div className={`bg-darkgreen text-light w-36 md:w-52 md:h-13 flex gap-2 px-2 items-center h-9 rounded`}>
              <Image className={"md:w-[34px]"} src={appSuporte} width={24} alt={"ICONE"}/>
              <p className={"font-bold text-[13px] md:text-xl "}>Leste Suporte</p>
          </div>}

          {central&& <div className={`bg-darkgreen text-light w-36 md:w-52 md:h-13 flex gap-2 px-2 items-center h-9 rounded`}>
              <Image className={"md:w-[34px]"} src={appCentral} width={24} alt={"ICONE"}/>
              <p className={"font-bold text-[13px] md:text-xl "}>Leste Central</p>
          </div>}

          {download&&
              <div className={`bg-darkgreen text-light max-w-96 h-17 p-4 flex justify-between gap-2 items-center rounded-xl`}>
