...
export default function Navbar() {
    ...
    return (
        <div
            className={`fixed top-0 left-0 w-full z-50 transition-transform duration-300 bg-gray-100 shadow 
        ${hidden ? "-translate-y-full" : "translate-y-0"}`}
        >
            <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
                <h1 className="text-xl font-bold text-green-700">Leste</h1>
                <nav className="flex gap-6 text-sm font-medium">
                    <a href="#home" className="hover:text-green-600">
                        Ultra
                    </a>
                    <a href="#mobile" className="hover:text-green-600">
                        Móvel
                    </a>
                    <a href="#app" className="hover:text-green-600">
                        App
                    </a>
