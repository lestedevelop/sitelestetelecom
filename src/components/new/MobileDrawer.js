...
export default function MobileDrawer({open, onClose, mobileInternetOpen, setMobileInternetOpen, INTERNET_DROPDOWN,setOpenSelectCity}){
    const {site} = useSite();
                ...
                <div className="rounded-xl border border-graylight overflow-hidden">
                    ...
                    >
                        <div className="flex items-center justify-between">
                            ...
                            <Image src={arrowDown} alt={""} className={`h-5 w-5 text-primary transition-transform ${mobileInternetOpen ? "rotate-180" : ""}`} />
                        </div>
                    </button>
